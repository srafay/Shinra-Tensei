...
print([number for number in a if number < 10])
...
userNumber = int(input("Enter a number for list comparision: "))
anotherList = [number for number in a if number < userNumber]
print("Custom list: {}" .format(anotherList))
